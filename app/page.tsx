    ...
    <div className='flex flex-col min-h-screen'>
        ...
        <div className='container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center'>
          <div>
            <h1 className='text-4xl font-bold mb-4'>
              Discover a world of possibilities: activities for children in our
              center!
            </h1>
            <p className='text-gray-600 mb-6'>
              We invite you and your children to our Open Days! This is a great
              opportunity to learn more about our programs, meet teachers, and
              see how we conduct classes.
            </p>
            <Button asChild>
      ...
      <section className='border-t bg-gray-50/50'>
        <div className='container py-12'>
          ...
          <p className='text-center text-gray-500 mb-12'>
            We invite you and your children to our Open Days! This is a great
            opportunity to learn more about our programs, meet teachers, and see
              ...
              <Card key={event.title}>
                <CardContent className='flex items-center justify-between p-2'>
                  <div className='flex items-center gap-4'>
                    <div className='h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center hidden md:flex transition-opacity duration-300 ease-in-ou'>
                      <CalendarDays className='h-6 w-6 text-primary hidden md:flex transition-opacity duration-300 ease-in-out' />
                    </div>
                    <div>
            ...
            <CardContent className='grid md:grid-cols-2 gap-6 p-6'>
              ...
              <div className='flex flex-col justify-center'>
                ...
                <blockquote className='text-xl italic mb-4'>
                  "Serenity Haven Wellness transformed my life. The support and
      ...
      <section className='border-t'>
        <div className='container py-12'>
          ...
          <p className='text-center text-gray-500 mb-12'>
            Do you want your child to participate in exciting and enriching
            activities? Sign up for our courses right now!
          </p>
          <div className='grid md:grid-cols-2 gap-12'>
            <div>
              <h3 className='text-xl font-semibold mb-4'>What We Offer</h3>
              <p className='text-gray-500'>
                We provide a variety of classes for children of different ages,
                from art and music courses to sports sections and science
                experiments. Each course is developed by experienced instructors
                to ensure engaging and safe learning.
              </p>
            ...
            <div>
              ...
              <ul className='space-y-4'>
                <li className='flex items-center gap-2'>
                  ...
                  <span>
                    Flexible class schedules for the convenience of parents
                  </span>
                </li>
                <li className='flex items-center gap-2'>
                  <CheckCircle className='h-5 w-5 text-primary' />
                  <span>
                    Small groups for a personalized approach to each child
                  </span>
                </li>
                <li className='flex items-center gap-2'>
                  <CheckCircle className='h-5 w-5 text-primary' />
                  <span>
                    A range of programs that foster skill development and
                    talents
                  </span>
                </li>
              </ul>
